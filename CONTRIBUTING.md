# Contributing to `ctmle3` development

We, the authors of the `ctmle3` R package, use the same guide as is used for
...
The goal of this guide is to help you get up and contributing to `ctmle3` as
...
To contribute a change to `ctmle3`, you follow these steps:
...
3.  __Use `ctmle3` coding style__. Please follow the
